...
//                  var_dump($page['content']['system_main']['nodes'][2]['#node']->metatags);
    ...
    <div class="margin-bottom-20">
        <div class="footer-logo min-width-15-percent" style="margin-left: 80px;">
            <img src="<?= path_to_theme() . "/images/footer/caefi.png" ?>">
        </div>

        <div class="footer-logo min-width-15-percent">
            <img src="<?= path_to_theme() . "/images/footer/eppa.png" ?>">
        </div>

        <div class="footer-logo min-width-10-percent">
            <img src="<?= path_to_theme() . "/images/footer/promota300.jpg" ?>">
        </div>

        <div class="footer-logo min-width-15-percent">
            <img src="<?= path_to_theme() . "/images/footer/sedex_trans.jpg" ?>">
        </div>
        <div class="footer-logo min-width-20-percent">
            <img src="<?= path_to_theme() . "/images/footer/PPAI-logo-QCS.jpg" ?>">
        </div>
    </div>
</div>